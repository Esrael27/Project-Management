...
CREATE TABLE `Task` (
    ...
    `description` VARCHAR(255) NULL,
    `status` ENUM('IN_PROGRESS', 'COMPLETED', 'ON_HOLD', 'CANCELLED') NOT NULL DEFAULT 'IN_PROGRESS',
...
-- AddForeignKey
ALTER TABLE `Issue` ADD CONSTRAINT `Issue_taskId_fkey` FOREIGN KEY (`taskId`) REFERENCES `Task`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
